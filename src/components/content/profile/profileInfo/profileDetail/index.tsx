...
const ProfileDetail:React.FC<ProfilePropsType> = (props) => {
...
let ProfileData:React.FC<ProfileType & ProfileDataPropsType> = props => {
    return (
        <>
            ...
            {Object.keys(props.contacts).length > 0 && <p className={style['user-info__desc']}>Contacts:
                {
                    Object.keys(props.contacts).map((key:string, i:number) => {
